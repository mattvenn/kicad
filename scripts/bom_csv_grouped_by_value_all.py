...
"""
    ...
    Fields are (if exist)
    'Ref', 'Qnty', 'Value', 'Cmp name', 'Footprint', 'Description', 'Vendor', 'Farnell #'
"""
...
out.writerow(['Ref', 'Qnty', 'Value', 'Cmp name', 'Footprint', 'Description', 'Vendor', 'Vendor P/N', 'farnell #', 'MOQ', 'Lead Time'])
